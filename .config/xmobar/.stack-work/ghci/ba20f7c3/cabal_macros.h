...
/* package xmobar-atif-0.16 */
#ifndef VERSION_xmobar_atif
#define VERSION_xmobar_atif "0.16"
#endif /* VERSION_xmobar_atif */
#ifndef MIN_VERSION_xmobar_atif
#define MIN_VERSION_xmobar_atif(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  16 || \
  (major1) == 0 && (major2) == 16 && (minor) <= 0)
#endif /* MIN_VERSION_xmobar_atif */
...
#define CURRENT_COMPONENT_ID "xmobar-atif-0.16-6xRAo6zdU6PGO46r78dihE-xmobar"
