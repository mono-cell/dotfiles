...
/* package config-0.1.0.0 */
#ifndef VERSION_config
#define VERSION_config "0.1.0.0"
#endif /* VERSION_config */
#ifndef MIN_VERSION_config
#define MIN_VERSION_config(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_config */
...
#define CURRENT_COMPONENT_ID "config-0.1.0.0-58byWujKstcBPz6fRQ3btj-xmobar-test"
